...
*Generated from 31 findings across 124 tests. Full data in [FINDINGS.md](FINDINGS.md). Simulator source: `zai-sim/` (Rust, 12 modules, 13+3 scenarios, 7 agent types).*
